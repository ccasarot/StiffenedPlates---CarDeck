...
%                                                                         %
%%%%%%%          A6 - Buckling of an isotropic plate                %%%%%%%
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Buckling - analitical solution
m = round(a/b);               % Approximate m to closest integer
if m==0  m=1;  end            % if closest integer is 0, fix
k = ((m*b/a)+(a/(m*b)))^2;    % Compute buckling coefficient k
sigma_c = (k*D*pi^2)/(b^2*t)  % Compute critical stress
